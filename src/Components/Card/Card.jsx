...
const convertToEn = (str) => {
  ...
  return str.replace(/[০-৯]/g, (w) => banglaDigits[w]);
};

const StatCard = ({ count, label, bgImage, icon, color }) => {
  const numericPart = count.replace(/[^\d০-৯]/g, '');
    ...
    >
      ...
      <div className="relative z-10 flex items-center w-full">
        ...
        <div className='w-3/5 pl-4'>
          <h2 className={`text-2xl md:text-3xl font-extrabold ${color} leading-none mb-2`}>
            <CountUp
              start={0}
              end={enNumber}
              duration={2.5}
