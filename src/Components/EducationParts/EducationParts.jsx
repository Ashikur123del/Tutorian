    ...
    <section className="py-4 md:py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          {/* LEFT CONTENT */}
          <div className="lg:col-span-8 space-y-14 max-w-3xl">
            ...
            <div>
              ...
              <div className="">
                {[
                  "যারা কুরআনকে গভীরভাবে ভাবতে চান এবং তার আধ্যাত্মিক ও জীবনের দিকগুলোকে অনুধাবন করতে চান।",
                  "যারা ইসলামের দৃষ্টিভঙ্গি থেকে আত্ম-উন্নয়ন ও জীবনসংক্রান্ত দিক খুঁজছেন।",
                  "যারা তফসির বা খুব গুরত্বপূর্ণ ধর্মীয় ব্যাখ্যার পরিবর্তে সহজ কিন্তু প্রভাবশালী চিন্তা চান।",
                  "যারা তাদের দৈনন্দিন জীবনের সঙ্গে কুরআনের নির্দেশনাকে মেলাতে এবং “কুরআন-ভিত্তিক জীবন” গড়তে চান।"
                ].map((item, i) => (
                  <div
                    key={i}
